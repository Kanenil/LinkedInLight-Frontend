    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white rounded-lg py-6">
            <div className="inline-flex w-full gap-5 pb-2 px-10 border-b-[1px] border-b-[#24459A]/50">
                ...
                <h1 className="font-jost text-xl text-[#2D2A33] font-medium">Edit page header</h1>
            </div>

            <div
                className="flex flex-col rounded-lg gap-5 p-2 mx-4 mt-4 md:mx-20"
            >
                <div className="flex flex-col gap-1 font-jost text-start mb-3">
                    <h1 className="text-[#2D2A33] font-medium text-lg">Update information about your company</h1>
                </div>
                ...
                <Show>
                    ...
                    <Show.Else>
                        <label htmlFor="logo">
                            ...
                            {errors.logo && <h3 className="mt-2 text-[#9E0F20] text-xs">{errors.logoImg}</h3>}
                        </label>
                    </Show.Else>
                </Show>
            ...
            <AddButtonVariant3 disabled={errors.logoImg || errors.companyName || errors.tagline || errors.linkedinUrl} type="submit" className="ml-auto mr-6 px-5 mt-5 disabled:bg-[#BABABA]">
                Save changes
            </AddButtonVariant3>
        </form>
    )
