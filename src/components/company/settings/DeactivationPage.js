...
import {AddButtonVariant3} from "../../../elements/buttons/AddButton";
    ...
    return (
        <div className="bg-white rounded-lg py-6">
            <div className="inline-flex w-full gap-5 pb-2 px-10 border-b-[1px] border-b-[#24459A]/50">
                ...
                <h1 className="font-jost text-xl text-[#2D2A33] font-medium">Page Deactivation</h1>
            </div>

            <div
                className="flex flex-col rounded-lg p-2 mx-4 mt-4 md:mx-10"
            >
                <div className="flex flex-col gap-1 font-jost text-start">
                    <h1 className="text-[#2D2A33] font-medium text-lg">It's unfortunate that you're leaving</h1>

                    <h3 className="text-[#A7A7A7] font-light">Deactivation will result in the complete deletion of the page from Job For You. After deactivation, you and other administrators will no longer have access to the page.</h3>
                </div>
                ...
                <AddButtonVariant3 onClick={onDelete} disabled={!value} className="ml-auto px-5 mt-5 disabled:bg-[#BABABA]">
                    Deactivate
                </AddButtonVariant3>
            </div>
        </div>
