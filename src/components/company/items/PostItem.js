        ...
        >
            <div className="flex flex-row pb-5 border-b-[1px] border-b-[#24459A]/50">
                <h1 className="font-jost text-sm text-[#7D7D7D] [&>a]:font-medium">
                    Posted by
                    <Link to={`/j4y/${postedBy.profileUrl}`}
                          className="text-[#2D2A33] ml-2 hover:underline">{postedBy.firstName} {postedBy.lastName}</Link>
                </h1>
            ...
            <div className="flex flex-col gap-3 mt-10">
                ...
                <ConditionalWrapper condition={image}>
                    <div
                        className='flex justify-center items-center border-[0.5px] border-[#7D88A4]/50 rounded-lg overflow-hidden my-auto w-full h-fit bg-white'>
                        <img
                            className='object-contain'
