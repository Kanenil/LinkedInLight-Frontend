...
const EditModalForm = ({
    ...
    return (
        <form onSubmit={onSubmit} className={classNames("flex flex-col", {
            ...
            <div className={classNames("flex justify-end pt-2.5 pb-1 gap-5", {
                ...
                <ConditionalWrapper condition={isEdit}>
                    <button onClick={onRemove}
                            type="button"
                            className={classNames("mr-auto text-[#24459A] font-medium hover:underline", {
                                "w-full": isMobile
                            })}>
                        Remove {removeTitle}
                    </button>
                ...
                <PrimaryButton type="submit" className={isMobile ? 'w-full' : ''}>
                    {saveTitle}
                </PrimaryButton>
            </div>
        </form>
