                        ...
                        <div className="flex flex-col px-6 py-6 bg-white h-[100dvh] w-screen">
                            ...
                            <div className="flex flex-col items-center mt-7 pt-2.5 pb-1 gap-2.5">
                                <div className="flex justify-center w-full items-start gap-5">
                                    ...
                                    <PrimaryButton className="w-full" onClick={handleDone}>
                                        Save image
                                    </PrimaryButton>
                                </div>
                    ...
                    <Show.Else>
                        <div onClick={onClose} className="flex h-screen">
                            <div onClick={e => e.stopPropagation()}
                                ...
                                <button className="mx-auto w-[40px] bg-[#24459A] h-1 rounded-full mb-5"
                                        onClick={onClose}/>
                                ...
                                <button onClick={() => document.querySelector('#changeImage').click()}
                                    ...
                                    <div className="flex flex-col gap-1.5 font-jost text-[#2D2A33] text-start">
                                        ...
                                        <h3 className="font-light text-sm">
                                            Upload a photo to make your profile as real as possible. We support your
                                            unique representation, without editing or filters - it's all about you here!
                                        </h3>
                                    </div>
                                </button>
                                <ConditionalWrapper condition={error}>
